...
abstract class AppLocalizations {
  ...
  /// No description provided for @signInLogin.
  ///
  /// In en, this message translates to:
  /// **'Login to Your Account'**
  String get signInLogin;
  ...
  /// No description provided for @verifyOTPTimer.
  ///
  /// In en, this message translates to:
  /// **'This code will expire in'**
  String get verifyOTPTimer;
  ...
  /// No description provided for @homeScreenCategory.
  ///
  /// In en, this message translates to:
  /// **'Categories'**
  String get homeScreenCategory;

  /// No description provided for @homeScreenAll.
  ///
  /// In en, this message translates to:
  /// **'See All'**
  String get homeScreenAll;
  ...
  /// No description provided for @categoryScreenTitle.
  ///
  /// In en, this message translates to:
  /// **'Categories'**
  String get categoryScreenTitle;
}
